...
void min_heap(int array[], int n, int parent) {
 ...
 cout<<"Before---> Parent: ("<<parent<<")"<<array[parent]<<"    Left: ("<<left<<")"<<array[left]<<"    Right : ("<<right<<")"<<array[right]<<endl;
    ...
    cout<<"After---> Parent: ("<<parent<<")"<<array[parent]<<"    Left: ("<<left<<")"<<array[left]<<"    Right : ("<<right<<")"<<array[right]<<endl;
