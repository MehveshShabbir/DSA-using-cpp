...
TreeNode<int>* search(TreeNode<int> *current,TreeNode<int> *pre_current, int* key)
{
    ...
    TreeNode<int> *current, *pre_current, *next;    // current will store key Node
        ...
        {   
            ...
            else if( current->getLeft() == NULL )
            {
                ...
                if(*current->getObject() < *pre_current->getObject())   
                    pre_current->setLeft(current);
                else if(*current->getObject() > *pre_current->getObject())   
                    pre_current->setRight(current);
            }
        ...
        {   
            ...
            cout<<"\tpre_current: "<<*pre_current->getObject();
            cout<<"\tnext: "<<*next->getObject();
            cout<<"\tCurrent: "<<*current->getObject();
            current->setObject(next->getObject());
            cout<<"\tCurrent: "<<*current->getObject();

            if(next->getLeft() == NULL)
                pre_current->setRight(NULL);
            else//(next->getLeft() != NULL)        
                pre_current->setRight(next->getLeft());
                cout<<"\ncurrent: "<<*current->getObject();
                cout<<"\tpre_current: "<<*pre_current->getObject();
                cout<<"\tnext: "<<*next->getObject();
                cout<<"\nROOT: "<<*((root->getLeft())->getLeft())->getObject();
            //delete next;
